        ...
        <div className="flex py-6 border-b">
            ...
            <div className="flex-1">
                ...
                <div className="flex items-center text-sm mb-3">
                    ...
                    <span className="truncate max-w-[256px]">{audio}</span>
                </div>

                <div className="flex">
                    {/* Video container */}
                    <div className="mr-5 w-[360px] h-[530px] bg-black rounded-md flex items-center justify-center relative overflow-hidden">
